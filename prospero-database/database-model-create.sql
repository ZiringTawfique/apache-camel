...
ALTER TABLE `ImportedEventsDB`.`ImportedEvents` 
CHANGE COLUMN `NumberRangeClassification` `NumberRangeClassification` VARCHAR(80) NOT NULL ;
...
INSERT INTO `AllSpark`.`BillingReference` (CustomerID,AccountNumber,OrderNumber,NodeID,AssetID,ServiceCode,BillingReference,BillingReferenceDescription,BillingReferenceStartDate,BillingReferenceEndDate,SupplierContractStartDate,SupplierContractEndDate,CustomerContractStartDate,CustomerContractEndDate) VALUES(234618,'FUL0005A',0,223952,'1725788','MOB','01772719060','not specified','2016-08-01 00:00:00.000',NULL,'2017-02-01 00:00:00.000','2020-01-31 00:00:00.000','2017-02-01 00:00:00.000','2020-01-31 00:00:00.000');
INSERT INTO `AllSpark`.`BillingReference` (CustomerID,AccountNumber,OrderNumber,NodeID,AssetID,ServiceCode,BillingReference,BillingReferenceDescription,BillingReferenceStartDate,BillingReferenceEndDate,SupplierContractStartDate,SupplierContractEndDate,CustomerContractStartDate,CustomerContractEndDate) VALUES(192306,'AFS00012',0,93990,'220350','MOB','02088901066','<not specified>','2009-06-16 00:00:00.000',NULL,'2009-06-16 00:00:00.000','2010-06-15 00:00:00.000','2009-06-16 00:00:00.000','2010-06-15 00:00:00.000');
INSERT INTO `AllSpark`.`BillingReference` (CustomerID,AccountNumber,OrderNumber,NodeID,AssetID,ServiceCode,BillingReference,BillingReferenceDescription,BillingReferenceStartDate,BillingReferenceEndDate,SupplierContractStartDate,SupplierContractEndDate,CustomerContractStartDate,CustomerContractEndDate) VALUES(355,'GCI0001A',0,93940,'219002','MOB','08000743318','<not specified>','2001-01-01 00:00:00.000',NULL,'2001-01-01 00:00:00.000','2001-01-31 00:00:00.000','2001-01-01 00:00:00.000','2001-01-31 00:00:00.000');
INSERT INTO `AllSpark`.`BillingReference` (CustomerID,AccountNumber,OrderNumber,NodeID,AssetID,ServiceCode,BillingReference,BillingReferenceDescription,BillingReferenceStartDate,BillingReferenceEndDate,SupplierContractStartDate,SupplierContractEndDate,CustomerContractStartDate,CustomerContractEndDate) VALUES(182523,'0024223',0,87165,'211533','MOB','08000743761','<no description provided>','2004-01-01 00:00:00.000',NULL,'2004-01-01 00:00:00.000','2003-12-31 00:00:00.000','2004-01-01 00:00:00.000','2004-01-31 00:00:00.000');
INSERT INTO `AllSpark`.`BillingReference` (CustomerID,AccountNumber,OrderNumber,NodeID,AssetID,ServiceCode,BillingReference,BillingReferenceDescription,BillingReferenceStartDate,BillingReferenceEndDate,SupplierContractStartDate,SupplierContractEndDate,CustomerContractStartDate,CustomerContractEndDate) VALUES(182523,'0024223',0,87167,'211535','MOB','08000743763','<no description provided>','2004-01-01 00:00:00.000',NULL,'2004-01-01 00:00:00.000','2003-12-31 00:00:00.000','2004-01-01 00:00:00.000','2004-01-31 00:00:00.000');
INSERT INTO `AllSpark`.`BillingReference` (CustomerID,AccountNumber,OrderNumber,NodeID,AssetID,ServiceCode,BillingReference,BillingReferenceDescription,BillingReferenceStartDate,BillingReferenceEndDate,SupplierContractStartDate,SupplierContractEndDate,CustomerContractStartDate,CustomerContractEndDate) VALUES(204328,'JPL001T',0,114736,'452632','MOB','08707560230','Billing Help','2002-08-13 00:00:00.000',NULL,'2002-08-13 00:00:00.000','2004-08-12 00:00:00.000','2002-08-13 00:00:00.000','2004-08-12 00:00:00.000');
COMMIT;