...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `EventsDB`.`ImportedEvent` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `EventsDB`.`KilledEvent` ;
...
CREATE INDEX `InvoiceNumber` ON `EventsDB`.`KilledEvent` (`InvoiceNumber` ASC);

CREATE INDEX `CustomerID` ON `EventsDB`.`KilledEvent` (`CustomerID` ASC);

CREATE INDEX `InvoiceBatchNumber` ON `EventsDB`.`KilledEvent` (`InvoiceBatchNumber` ASC);

CREATE INDEX `EventRecordID` ON `EventsDB`.`KilledEvent` (`EventRecordID` ASC);

CREATE INDEX `EventID` ON `EventsDB`.`KilledEvent` (`EventID` ASC);

CREATE INDEX `AccountingPeriod` ON `EventsDB`.`KilledEvent` (`AccountingPeriod` ASC);

CREATE INDEX `EventBandID` ON `EventsDB`.`KilledEvent` (`EventBandID` ASC);

CREATE INDEX `RatingPlanID` ON `EventsDB`.`KilledEvent` (`RatingPlanID` ASC);

CREATE INDEX `CarrierID` ON `EventsDB`.`KilledEvent` (`CarrierID` ASC);

CREATE INDEX `CarrierTariffID` ON `EventsDB`.`KilledEvent` (`CarrierTariffID` ASC);


-- -----------------------------------------------------
-- Table `EventsDB`.`RatedEvent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `EventsDB`.`RatedEvent` ;
...
CREATE INDEX `InvoiceNumber` ON `EventsDB`.`RatedEvent` (`BilledInvoiceNumber` ASC);

CREATE INDEX `CustomerID` ON `EventsDB`.`RatedEvent` (`CustomerID` ASC);

CREATE INDEX `InvoiceBatchNumber` ON `EventsDB`.`RatedEvent` (`BilledInvoiceBatchNumber` ASC);

CREATE INDEX `EventRecordID` ON `EventsDB`.`RatedEvent` (`EventRecordID` ASC);

CREATE INDEX `EventID` ON `EventsDB`.`RatedEvent` (`EventID` ASC);

CREATE INDEX `AccountingPeriod` ON `EventsDB`.`RatedEvent` (`AccountingPeriod` ASC);

CREATE INDEX `EventBandID` ON `EventsDB`.`RatedEvent` (`EventBandID` ASC);

CREATE INDEX `RatingPlanID` ON `EventsDB`.`RatedEvent` (`RatingPlanID` ASC);

CREATE INDEX `CarrierID` ON `EventsDB`.`RatedEvent` (`CarrierID` ASC);

CREATE INDEX `CarrierTariffID` ON `EventsDB`.`RatedEvent` (`CarrierTariffID` ASC);

CREATE INDEX `fk_RatedEvent_InvoiceChargeSummary1_idx` ON `EventsDB`.`RatedEvent` (`BilledInvoiceChargeSummaryID` ASC);
...
-- -----------------------------------------------------
-- Table `ImportedEventsDB`.`ImportedEvents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ImportedEventsDB`.`ImportedEvents` ;

CREATE TABLE IF NOT EXISTS `ImportedEventsDB`.`ImportedEvents` (
  ...
  `EventTime` DATETIME NOT NULL,
  `EventDurationSecs` BIGINT NOT NULL,
  `WeekDayFlag` CHAR NOT NULL,
