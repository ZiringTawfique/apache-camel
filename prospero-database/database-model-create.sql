...
CREATE TABLE IF NOT EXISTS `InvoiceDB`.`InvoiceSummary` (
  ...
  INDEX `fk_InvoiceSummary_PaymentType_idx` (`InvoicePaymentTypeID` ASC),
  INDEX `fk_InvoiceSummary_BillType1_idx` (`BillTypeID` ASC),
  INDEX `fk_InvoiceSummary_InvoiceLayoutType1_idx` (`InvoiceLayoutTypeID` ASC),
  INDEX `fk_InvoiceSummary_InvoiceType1_idx` (`InvoiceTypeID` ASC),
  INDEX `fk_InvoiceSummary_InvoicingCompany1_idx` (`InvoicingCompanyID` ASC),
  INDEX `fk_InvoiceSummary_InvoiceBatchSummary1_idx` (`InvoiceBatchNumber` ASC),
  INDEX `fk_InvoiceSummary_Address1_idx` (`AddressID` ASC),
...
CREATE TABLE IF NOT EXISTS `AllSpark`.`BillingReference` (
  ...
  INDEX `fk_BillingReference_Customer1_idx` (`CustomerID` ASC),
...
CREATE TABLE IF NOT EXISTS `AllSpark`.`CustomerProductCharge` (
  ...
  INDEX `fk_CustomerProductCharge_Customer_idx` (`CustomerID` ASC),
  INDEX `fk_CustomerProductCharge_BillingReference1_idx` (`BillingReferenceID` ASC),
...
CREATE TABLE IF NOT EXISTS `InvoiceDB`.`InvoiceChargeSummary` (
  ...
  INDEX `fk_InvoiceChargeSummary_InvoiceSummary1_idx` (`InvoiceNumber` ASC),
  INDEX `fk_InvoiceChargeSummary_InvoiceBatchSummary1_idx` (`InvoiceBatchNumber` ASC),
  INDEX `fk_InvoiceChargeSummary_CustomerProductCharge1_idx` (`CustomerProductChargeID` ASC),
  INDEX `fk_InvoiceChargeSummary_ChargeHistoryType1_idx` (`ChargeHistoryTypeID` ASC),
  INDEX `fk_InvoiceChargeSummary_ProductChargeCategory1_idx` (`ProductChargeCategoryID` ASC),
  INDEX `fk_InvoiceChargeSummary_ProductChargeFrequency1_idx` (`ProductChargeFrequencyID` ASC),
  INDEX `fk_InvoiceChargeSummary_Customer1_idx` (`CustomerID` ASC),
...
-- -----------------------------------------------------
-- Table `AllSpark`.`AuditEvent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `AllSpark`.`AuditEvent` (
  `AuditEventID` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `AllSpark`.`AuditEventData`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `AllSpark`.`AuditEventData` (
  `AuditEventID` BIGINT NOT NULL,
  `DataName` VARCHAR(30) NOT NULL,
  `Value` TEXT NOT NULL,
  PRIMARY KEY (`AuditEventID`, `DataName`),
  CONSTRAINT `fk_AuditEventData_AuditEvent1`
    FOREIGN KEY (`AuditEventID`)
    REFERENCES `AllSpark`.`AuditEvent` (`AuditEventID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `EventsDB`.`ImportedEvent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EventsDB`.`ImportedEvent` (
  `ImportedEventID` BIGINT NOT NULL,
  `AccountingPeriod` VARCHAR(10) NOT NULL,
  `CustomerID` BIGINT NOT NULL,
  `AccountNumber` VARCHAR(15) NOT NULL,
  `DialledCLI` VARCHAR(20) NOT NULL,
  `OriginatingCLI` VARCHAR(20) NOT NULL,
  `TerminatingCLI` VARCHAR(20) NOT NULL,
  `PresentationCLI` VARCHAR(20) NOT NULL,
  `EventDurationSecs` INT NOT NULL,
  `EventFileID` BIGINT NOT NULL,
  `NumberRange` VARCHAR(20) NOT NULL,
  `NumberRangeClassification` VARCHAR(30) NOT NULL,
  `NumberRangeType` VARCHAR(30) NOT NULL,
  `PreRatedEventFlag` TINYINT(1) NOT NULL,
  `SupplierID` BIGINT NOT NULL,
  `SupplierAccountNumber` VARCHAR(20) NOT NULL,
  `SupplierCost` DECIMAL(18,4) NOT NULL,
  `SupplierNumberRange` VARCHAR(20) NOT NULL,
  `SupplierNumberRangeMap` VARCHAR(255) NOT NULL,
  `SupplierNumberRangePattern` VARCHAR(255) NOT NULL,
  `SupplierRatingPattern` VARCHAR(255) NOT NULL,
  `SupplierRecordReference` VARCHAR(255) NOT NULL,
  `SupplierServiceType` VARCHAR(255) NOT NULL,
  `SupplierTariffPlanID` BIGINT NOT NULL,
  `TimePeriod` VARCHAR(255) NOT NULL,
  `WeekdayFlag` INT NOT NULL,
  PRIMARY KEY (`ImportedEventID`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `EventsDB`.`KilledEvent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EventsDB`.`KilledEvent` (
  ...
  INDEX `InvoiceNumber` (`InvoiceNumber` ASC),
  INDEX `CustomerID` (`CustomerID` ASC),
  INDEX `InvoiceBatchNumber` (`InvoiceBatchNumber` ASC),
  INDEX `EventRecordID` (`EventRecordID` ASC),
  INDEX `EventID` (`EventID` ASC),
  INDEX `AccountingPeriod` (`AccountingPeriod` ASC),
  INDEX `EventBandID` (`EventBandID` ASC),
  INDEX `RatingPlanID` (`RatingPlanID` ASC),
  INDEX `CarrierID` (`CarrierID` ASC),
  INDEX `CarrierTariffID` (`CarrierTariffID` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `EventsDB`.`RatedEvent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EventsDB`.`RatedEvent` (
  `EventRecordID` DECIMAL(10) NOT NULL,
  `EventRecordCreateDate` DATETIME NOT NULL,
  `CustomerID` DECIMAL(10) NOT NULL,
  `AccountNumber` VARCHAR(15) NULL,
  ...
  `ChargeTaxTypeFlag` DECIMAL(2) NULL,
  `DuplicateFlag` TINYINT NULL,
  INDEX `InvoiceNumber` (`BilledInvoiceNumber` ASC),
  INDEX `CustomerID` (`CustomerID` ASC),
  INDEX `InvoiceBatchNumber` (`BilledInvoiceBatchNumber` ASC),
  INDEX `EventRecordID` (`EventRecordID` ASC),
  INDEX `EventID` (`EventID` ASC),
  INDEX `AccountingPeriod` (`AccountingPeriod` ASC),
  INDEX `EventBandID` (`EventBandID` ASC),
  ...
  INDEX `CarrierID` (`CarrierID` ASC),
  INDEX `CarrierTariffID` (`CarrierTariffID` ASC),
  INDEX `fk_RatedEvent_InvoiceChargeSummary1_idx` (`BilledInvoiceChargeSummaryID` ASC),
