...
public final class AppProperties {
	...
	public static final String REFERENCE_DB_URL_KEY = "gci.datasource.ref.url";
	
	public static final String REFERENCE_DB_USER_KEY = "gci.datasource.ref.username";
	
	public static final String REFERENCE_DB_PASSWORD_KEY = "gci.datasource.ref.password";
}
